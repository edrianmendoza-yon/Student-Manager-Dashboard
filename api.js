...
console.log(`Initial DB State: ${JSON.stringify(mockStudentDb)}`);
...
let addStudentAPI = (newStudentData) => {
...
console.log(`Returned Saved Object: ${JSON.stringify(mockStudentDb[2])}`);
console.log(`Updated DB State: ${JSON.stringify(getStudentsAPI())}`);